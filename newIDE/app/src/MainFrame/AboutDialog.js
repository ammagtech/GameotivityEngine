...
const contributors = [
  ...
  // Code contributors
  {
    ...
    description:
      'Numerous code contributions to Gameotivity and community moderation',
  },
  {
    name: 'Lizard-13',
    description:
  ...
  { name: 'ale26reg', description: 'Contributions to Gameotivity' },
  { name: 'dos1', description: 'Contributions to Gameotivity' },
  {
    name: 'Aurélien Vivet',
    description:
      'Numerous code contributions to Gameotivity and community management',
    link: 'https://www.witly.fr',
  },
  {
    name: 'Todor Imreorov',
    description: 'Numerous code contributions to Gameotivity',
  },
  { name: 'brylie', description: 'Contributions to Gameotivity' },
  { name: 'Nnarol', description: 'Contributions to Gameotivity' },
  { name: 'wild-master', description: 'Contributions to Gameotivity' },
  { name: 'RandomShaper', description: 'Contributions to Gameotivity' },
  { name: 'RyanNerd', description: 'Contributions to Gameotivity' },
  { name: 'greater', description: 'Contributions to Gameotivity' },
  { name: 'triptych', description: 'Contributions to Gameotivity' },
  {
    name: 'Wend1go',
    description: 'Contributions to Gameotivity, Tutorials, Examples',
  },
  { name: 'mattiascibien', description: 'Contributions to Gameotivity' },
  { name: 'araujo921', description: 'Contributions to Gameotivity' },
  { name: 'ronnystandtke', description: 'Contributions to Gameotivity' },
  {
    name: 'Thomas Flecy',
    description: 'Contributions to Gameotivity (original sound object extension)',
  },
  {
...
const AboutDialog = ({ onClose, updateStatus }: Props) => {
  ...
  return (
    <Dialog
      title={<Trans>About Gameotivity</Trans>}
      actions={[
        <FlatButton
          key="website"
          label={<Trans>Gameotivity Website</Trans>}
          primary={false}
          onClick={() => Window.openExternalURL('https://gameotivity.com/')}
        />,
        <FlatButton
          key="close"
      ...
      fixedContent={
        <ColumnStackLayout noMargin>
          ...
          <Tabs
            ...
            options={[
              { value: 'about', label: <Trans>About Gameotivity</Trans> },
    ...
    >
        ...
        <React.Fragment>
          <Line>
            <ColumnStackLayout>
              <Text>
                <Trans>
                  Gameotivity is a full-featured, open-source game engine. Build
              ...
              <Text allowSelection>
                <Trans>This version of Gameotivity is:</Trans> {getIDEVersion()}{' '}
      ...
      {currentTab === 'contributors' && (
        <React.Fragment>
          <Column>
            <Text>
              <Trans>Gameotivity is created by AMMAG Technologies.</Trans>
            </Text>
            <Text>
          ...
          <Column expand>
            <Text>
              <Trans>
                Thanks to all users of Gameotivity! There must be missing tons of
            ...
            <Line alignItems="center" justifyContent="center">
              <FlatButton
                label={<Trans>Contribute to Gameotivity</Trans>}
