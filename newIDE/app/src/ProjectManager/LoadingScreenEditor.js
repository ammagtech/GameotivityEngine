            ...
            <ResponsiveLineStackLayout noResponsiveLandscape noMargin>
              <Column expand noMargin justifyContent="center">
                <Checkbox
                  label={
                    <Trans>
                      Display Gameotivity logo at startup (in exported game)
                    </Trans>
                  }
              ...
              <Column expand noMargin justifyContent="center">
                <SelectField
                  fullWidth
                  floatingLabelText={<Trans>Gameotivity logo style</Trans>}
            ...
            <ResponsiveLineStackLayout noResponsiveLandscape noMargin>
              <Column expand noMargin justifyContent="center">
                <Checkbox
                  label={
                    <Trans>
                      Display Gameotivity watermark after the game is loaded (in
                      exported game)
                    </Trans>
                  }
              ...
              <Column expand noMargin justifyContent="center">
                <SelectField
                  fullWidth
                  floatingLabelText={
                    <Trans>Gameotivity watermark placement</Trans>
                  }
